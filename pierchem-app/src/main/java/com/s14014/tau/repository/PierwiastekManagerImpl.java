...
public class PierwiastekManagerImpl implements IPierwiastekRepository{
    ...
    public void createTables() throws SQLException{
        connection.createStatement().executeUpdate(
            "CREATE TABLE " + 
            "Pierwiastek(id int GENERATED BY DEFAULT AS IDENTITY," + 
            "nazwa varchar(30) NOT NULL," + 
            "nrOkresu int(255) NOT NULL," + 
            "nrGrupy int(255) NOT NULL," + 
            "liczbaElektronow int(255) NOT NULL)"
        );      
    }
    ...
    public void setConnection(Connection connection) throws SQLException {
        ...
        prepareStatement("DROP TALE Pierwiastek");
    }
	...
	public Pierwiastek getPierwiastekById(int id) {
        ...
        try{
            ...
            while(rs.next()){
                pierwiastek.setId(rs.getInt("int"));
